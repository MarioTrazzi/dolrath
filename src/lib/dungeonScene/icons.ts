 ...
 * `/scene/common/<flavor>-1.webp` (cheio) e `<flavor>-used-1.webp` (gasto).
 * `common` e não `<bioma>`: um baú é o mesmo baú em qualquer masmorra, então a
 * arte é COMPARTILHADA — bioma novo não precisa refazer achado nenhum.

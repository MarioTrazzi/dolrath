...
//
// Vive dentro do Mapa do Reino (/gathering): a Vila de Dolrath é a porta de
      ...
      <div className="max-w-4xl mx-auto">
        {onBack && (
          <button
            type="button"
            onClick={onBack}
            className="mb-4 rounded-[3px] border border-[#46464c] px-3 py-1.5 text-sm text-[#c9c9ce] transition-colors hover:border-[#8a6d3b] hover:text-[#e7c682]"

...
async function seedBattleConsumables() {
  ...
  for (const consumable of battleConsumables) {
    try {
      ...
      console.log(`❌ Erro ao criar ${consumable.name}:`, error.message)
    }
  }

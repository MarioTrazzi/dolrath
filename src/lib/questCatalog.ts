...
// title/description em EN (i18n EN-as-key) — a UI passa por t();
// o `id` é a chave interna, não o título.
export const QUEST_CATALOG: QuestDef[] = [
  // ——— Tutorial: "A Jornada do Herói" (uma vez por personagem, em ordem) ———
  {
    ...
    description: 'Start a gathering session and deposit 5 resources (ore, herbs or wood).',
  ...
  },
  {
    ...
    description: 'Plant and harvest 3 times on the farm.',
  ...
  },
  {
    ...
    order: 3,
    icon: '⚒️',
    title: 'Apprentice of the Craft',
    description: 'Produce 1 item in any craft: forge, alchemy, processing or cooking.',
  ...
  },
  {
    ...
    description: 'Defeat 5 monsters exploring the dungeons.',
  ...
  },
  {
    ...
    order: 6,
    icon: '🛡️',
    title: 'Trial in the Arena',
    description: 'Take part in 1 PvP duel in the arena (win or lose).',
  ...
  },
  {
    ...
    order: 7,
    icon: '🏅',
    title: 'Veteran of Dolrath',
    description: 'Reach level 5 with this character.',
  ...
  // ——— Diárias (reset à meia-noite UTC) ———
  {
    ...
    kind: 'DAILY',
    icon: '⛏️',
    title: 'Harvest of the Day',
    description: 'Deposit 10 gathered resources today.',
  ...
  },
  {
    ...
    icon: '🌾',
    title: 'Farm Routine',
    description: 'Make 5 harvests on the farm today.',
  ...
  },
  {
    ...
    icon: '⚔️',
    title: 'Dungeon Sweep',
    description: 'Defeat 10 monsters in the dungeons today.',
  ...
  },
  {
    ...
    icon: '👑',
    title: 'Boss Hunt',
    description: 'Defeat 1 dungeon boss today.',
    objective: { event: 'dungeon_boss_kill', count: 1 },
    rewards: { gold: 400, xp: 150 },
    href: '/dungeons',
  },
  {
    ...
    description: 'Win 1 PvP duel today.',

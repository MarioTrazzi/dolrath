...
const SLOT_FACTOR: Record<string, number> = {
  ...
  // ⚠️ Os pesos MEDIUM faltavam: SLOT_FACTOR[type] saía undefined e o item era
  // PULADO em silêncio pela auditoria (nenhum MEDIUM_HELMET/GLOVES/BOOTS existia
  // no catálogo até 2026-08-21, então o buraco nunca tinha aparecido).
  LIGHT_HELMET: 0.6, MEDIUM_HELMET: 0.6, HEAVY_HELMET: 0.6,
  LIGHT_GLOVES: 0.6, MEDIUM_GLOVES: 0.6, HEAVY_GLOVES: 0.6,
  LIGHT_BOOTS: 0.6, MEDIUM_BOOTS: 0.6, HEAVY_BOOTS: 0.6,
